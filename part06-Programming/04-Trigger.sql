...
CREATE TRIGGER TR_CheckInsertionOnEvent ON Event -- muốn có 1 Trig kiểm tra cái Event khi Insert 
FOR INSERT -- tao có 1 hàm void tên là .... hàm này dc gọi trên cái Table Event được Insert data 
AS -- Pro thì hàm xử lý thôi , còn hàm Trig là gắn chặt với table Event trên sự kiện Insert 
BEGIN
